...
class CameraWindowsSample extends StatefulWidget {
  /// Default Constructor
  const CameraWindowsSample({super.key});

  @override
  State<CameraWindowsSample> createState() => _CameraWindowsSampleState();
}

class _CameraWindowsSampleState extends State<CameraWindowsSample> {
