// ignore_for_file: unused_import, prefer_typing_uninitialized_variables, unused_local_variable, unused_field
...
class _AddStickerState extends State<AddSticker> {
            ...
            Container(
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      _dialogBuilderSticker(
                          context, "sticker 7", "21_google_v1");
                    },
                    child: Container(
                      child: Padding(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: const BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(
                                      "assets/props/google/21_google_v1.png",
                                    ),
                                    fit: BoxFit.contain),
                              ),
                            ),
                  ...
                  InkWell(
                    onTap: () {
                      _dialogBuilderSticker(
                          context, "sticker 8", "29_google_v1");
                    },
                    child: Container(
                      child: Padding(
                        padding: EdgeInsets.all(width * 0.0045),
                          ...
                          children: [
                            Container(
                              ...
                              decoration: const BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(
                                      "assets/props/google/29_google_v1.png",
                                    ),
                                    fit: BoxFit.contain),
                              ),
                            ),
                  ...
                  InkWell(
                    onTap: () {
                      _dialogBuilderSticker(
                          context, "sticker 9", "30_google_v1");
                    },
                    child: Container(
                      child: Padding(
                        padding: EdgeInsets.all(width * 0.0045),
                          ...
                          children: [
                            Container(
                              ...
                              decoration: const BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(
                                      "assets/props/google/30_google_v1.png",
                                    ),
                                    fit: BoxFit.contain),
                              ),
                            ),
                  ...
                  InkWell(
                    onTap: () {
                      _dialogBuilderSticker(
                          context, "sticker 10", "32_google_v1");
                    },
                    child: Container(
                      child: Padding(
                        padding: EdgeInsets.all(width * 0.0045),
                          ...
                          children: [
                            Container(
                              ...
                              decoration: const BoxDecoration(
                                image: DecorationImage(
                                    image: AssetImage(
                                      "assets/props/google/32_google_v1.png",
                                    ),
                                    fit: BoxFit.contain),
                              ),
                            ),
  ...
  _updateSticker(status, nama, icon) async {
    db.getConnection().then(
      (value) {
        // query update "UPDATE filter SET status = 'aktif' WHERE nama = 'mute';"
        String sql =
            "UPDATE sticker SET status = '$status', icon = '$icon' WHERE nama = '$nama';";
        value.query(sql).then((value) {
          print("berhasil update sticker $nama status $status");
...
// dialog background
  Future<void> _dialogBuilderSticker(BuildContext context, nama, icon) {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Menambah Sticker Ini?'),
          content: Text(
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                _updateSticker("tidak aktif", nama, icon);
                Navigator.of(context).pop();
              },
            ),
            TextButton(
              ...
              onPressed: () {
                _updateSticker("aktif", nama, icon);
                Navigator.of(context).pop();
              },
            ),
          ],
          ...
          child: Padding(
            ...
            child: AlertDialog(
              ...
              actions: <Widget>[
                ...
                //     //   context,
                //     //   MaterialPageRoute(
                //     //     builder: (context) => const HomeAddSticker(),
                //     //   ),
                //     // );
